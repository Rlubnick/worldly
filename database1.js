...
window.onload = function(){
  ...
  newTodoInput = document.getElementById('myGoal');
}
...
function refreshTodos() {
  todoDB.fetchTodos(function(todos) {
    ...
    var todoList = document.getElementById('entry');
    todoList.innerHTML = '';
    ...
    for(var i = 0; i < todos.length; i++) {
      ...
      entryDiv.innerText = todo.text;
      
      actualDiv.appendChild(entryDiv);
      todoList.appendChild(actualDiv);
      // actualDiv.appendChild(checkbox);
